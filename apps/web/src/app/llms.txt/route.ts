...
export function GET() {
  const body = [
    ...
    `- English datasheets: ${buildAbsoluteUrl('/en/resources/datasheets')}`,
    `- English case studies: ${buildAbsoluteUrl('/en/resources/case-studies')}`,
    `- English podcast: ${buildAbsoluteUrl('/en/resources/podcast')}`,
    ...
    `- Kron PAM: ${buildAbsoluteUrl('/en/products/kron-pam')}`,
    `- Cloud PAM: ${buildAbsoluteUrl('/en/products/cloud-pam')}`,
    `- Solutions: ${buildAbsoluteUrl('/en/solutions/privileged-access-security')}`,
    `- PAM as a Service: ${buildAbsoluteUrl('/en/solutions/pam-as-a-service')}`,
    `- Partners: ${buildAbsoluteUrl('/en/partners')}`,
    `- About: ${buildAbsoluteUrl('/en/about-us')}`,
    `- Contact: ${buildAbsoluteUrl('/en/contact')}`,
    `- Request demo: ${buildAbsoluteUrl('/en/demo-request')}`,
    '',
